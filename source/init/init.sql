...
DROP DATABASE IF EXISTS metadata_hge1 WITH (FORCE);
CREATE DATABASE metadata_hge1;

DROP DATABASE IF EXISTS metadata_hge2 WITH (FORCE);
CREATE DATABASE metadata_hge2;
