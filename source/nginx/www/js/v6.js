...
const fetchTableData = async function() {
    ...
    if (Object.prototype.hasOwnProperty.call(result, 'data')) {
        result.data.sku.forEach(function(sku) {
            let row = {
                sku: sku.sku_id,
                quantity: 0
            };
            ...
            if (Object.prototype.hasOwnProperty.call(sku, 'rating')) {
                row.score = sku.rating.score ? sku.rating.score : '';
            }
